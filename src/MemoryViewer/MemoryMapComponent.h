...
class MemoryMapComponent:public JPanel implements MemoryInfoUpdateListener, TreeSelectionListener, ItemListener, ActionListener
{

	
	// Constants
    private: static constexpr QStringView SELECTION_RAW = "Raw";
    private: static constexpr QStringView SELECTION_FILTERED = "Filtered";
    private: static constexpr QStringView SELECTION_COMPRESSED = "Compressed";
	
	// Listeners
    private: std::vector<MemoryDetailsListener> memoryDetailsListeners;
	...
	// Tree view
    private: JComboBox<QString> memoryMapSelectionBox;
    ...
    public: MemoryMapComponent () {
		...
		memoryDetailsListeners = new std::vector<MemoryDetailsListener>();
		rawMemoryMap = nullptr;
		filteredMemoryMap = nullptr;
		compressedMemoryMap = nullptr;
		
		// Create contents
		JSplitPane splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT);
		memoryMapTree = new MemoryMapTree();
		memoryMapSelectionBox = new JComboBox<QString>();
...
class MemoryMapTree:public JTree
{
    ...
    public: QString convertValueToText (Object value, bool selected, bool expanded, bool leaf, int row, bool hasFocus) {
...
class MemoryMapPicture:public JPanel
{

	
	// Constants
    private: static constexpr double zoomFactor = 2;
    private: static constexpr double maxZoomIn = 8;
    private: static constexpr double minZoomIn = 0.001;
    private: static constexpr int offsetX = 20;
    private: static constexpr int offsetY = 20;
    private: static constexpr int width = 200;
    private: static constexpr int selectedRegionWidth = 50;
    ...
    public: MemoryMapPicture () {
		...
		selectedSubRegion = nullptr;
		selectedRegionData = nullptr;
		scale = 0.25;
		focus = false;
